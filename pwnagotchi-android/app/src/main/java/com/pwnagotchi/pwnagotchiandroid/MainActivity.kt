                    ...
                    when {
                        ...
                        showPlugins -> {
                            ...
                            if (uiState is PwnagotchiUiState.Connected) {
                                PluginsScreen(
                                    installedPlugins = (uiState as PwnagotchiUiState.Connected).plugins,
                                    communityPlugins = (uiState as PwnagotchiUiState.Connected).communityPlugins,
                        ...
                        showOpwngrid -> {
                            ...
                            PwnagotchiScreen(
                                ...
                                onPlugins = {
                                    pwnagotchiService?.listPlugins()
                                    pwnagotchiService?.getCommunityPlugins()
                                    showPlugins = true
                                },
                                onOpwngrid = {
