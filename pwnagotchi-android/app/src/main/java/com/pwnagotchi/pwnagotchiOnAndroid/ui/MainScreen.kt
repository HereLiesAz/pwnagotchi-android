...
import com.pwnagotchi.pwnagotchiOnAndroid.*
import com.pwnagotchi.pwnagotchiOnAndroid.ui.navigation.Screen
import com.pwnagotchi.pwnagotchiOnAndroid.ui.theme.PwnagotchiAndroidTheme
import com.pwnagotchi.pwnagotchiOnAndroid.viewmodels.PluginsViewModel
...
fun HomeScreen(viewModel: PwnagotchiViewModel) {
    ...
    Column(
        ...
        when (appMode) {
            AppMode.REMOTE -> {
                val pwnagotchiScreenViewModel: com.pwnagotchi.pwnagotchiOnAndroid.viewmodels.PwnagotchiViewModel = viewModel()
